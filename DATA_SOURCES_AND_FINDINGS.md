...
1. **Gaps Are Significant and Widening**
   ...
   - North Macedonia's gap nearly 5× larger than 2009 baseline
...
## 🔮 Forecasting (Based on Linear Regression)
...
**⚠️ Warning:** Without policy intervention, both countries may see gaps exceed 20% by 2030.
...
- ✓ Outliers identified and documented
- ✓ Trends calculated and validated
